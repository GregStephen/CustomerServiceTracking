...
const PublicRoute = ({ component: Component, authorized, ...rest }) => {
  ...
  const routeChecker = (props) => (authorized === false ? <Component authorized={authorized}{...props} {...rest} /> : <Redirect to={{ pathname: '/hpme', state: { from: props.location } }} />);
    ...
    return (
      <div className="App">
        <Router>
          <NavigationBar/>
          <Switch>
            <PublicRoute path='/landing-page' component={LandingPage} authorized={authorized}/>
